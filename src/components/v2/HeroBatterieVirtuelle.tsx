  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden">
      <img
        ...
        alt="Installation panneaux solaires avec batterie virtuelle en Occitanie"
        fetchPriority="high"
        decoding="async"
      ...
      <div className="relative z-10 container mx-auto px-6 text-center py-[40px]">
        <a
          href="#offre"
          className="mb-8 inline-flex items-center gap-2 rounded-full border border-primary-foreground/20 bg-primary-foreground/10 px-4 py-2 text-xs sm:text-sm font-semibold text-primary-foreground backdrop-blur-sm transition-all hover:bg-primary-foreground/20 max-w-[90vw] text-center"
        >
        ...
        <h1 className="mx-auto mb-8 max-w-4xl text-4xl font-normal leading-tight text-primary-foreground md:text-5xl lg:text-6xl">
          ...
          <br />
          <span className="text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.4)]">
            Stockez Votre Surplus Solaire
          </span>
          <br />
          <span className="text-primary-foreground/90 drop-shadow-[0_2px_10px_rgba(0,0,0,0.4)]">
            Sans Batterie Physique
          </span>
        </h1>

        <p className="mx-auto mb-4 max-w-2xl text-lg font-light text-primary-foreground/70">
          Sans batterie, vous revendez votre surplus à 0,04€/kWh. Avec la batterie virtuelle, vous consommez tout, même la nuit.
        </p>
...
export default HeroBatterieVirtuelle;