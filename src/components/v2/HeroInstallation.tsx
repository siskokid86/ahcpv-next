  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden">
      <img
        ...
        alt="Installation panneaux solaires sur maison individuelle en Occitanie"
        fetchPriority="high"
        decoding="async"
      ...
      <div className="relative z-10 container mx-auto px-6 text-center py-[40px]">
        ...
        <p className="mb-8 flex items-center justify-center gap-2 text-sm text-primary-foreground/60">
          <Zap className="h-4 w-4 text-warning" />
          1 557+ installations · Depuis 2006 · Garantie 30 ans
        </p>
